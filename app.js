...
var noisetweet = require('./modules/noisetweet');
...
tw.on('tweet',function(tweet){
  ...
  if(tweet.id_str !== lastTweetId && (isRetweet === false) && (isMention === false) && (isQuoted === false)){

    // check against spam terms
    if(spamtweet(tweet.text) === false){

      // check against noise terms
      if(noisetweet(tweet.text) === false){      
